              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: const Text('Contact Us', style: TextStyle(color: Colors.orange)),
                  ),
                  const SizedBox(height: 20),
                  const Text(
                    'We\'re Here to Help!',
            ...
            Form(
              ...
              child: Column(
                children: [
                  ...
                  const SizedBox(height: 10),
                  buildTextField(controller: messageController, hint: 'Description', maxLines: 4),
                    ...
                    onPressed: () {
                      if (_formKey.currentState!.validate()) {
                        ...
                        ScaffoldMessenger.of(context).showSnackBar(
                          const SnackBar(content: Text('Message Sent! (Dummy Action)')),
                        );
                      }
                    },
