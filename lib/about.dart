              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: const Text('Our Story', style: TextStyle(color: Colors.orange)),
                  ),
                  const SizedBox(height: 20),
                  RichText(
                    ...
                    text: const TextSpan(
                      ...
                      children: [
                        TextSpan(text: 'One Student at a Time', style: TextStyle(color: Colors.orange)),
                      ],
                    ),
                  ),
        ...
        child: Padding(
          ...
          child: Column(
            children: [
              ...
              Text(description, textAlign: TextAlign.center, style: const TextStyle(fontSize: 12, color: Colors.black54)),
            ],
          ),
        ),
      ),
